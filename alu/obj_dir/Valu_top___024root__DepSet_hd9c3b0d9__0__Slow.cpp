...
VL_ATTR_COLD void Valu_top___024root___initial__TOP__0(Valu_top___024root* vlSelf) {
    ...
    VL_READMEM_N(true, 32, 32, 0, VL_CVT_PACK_STR_NW(3, __Vtemp_hb978afc8__0)
...
VL_ATTR_COLD void Valu_top___024root___ctor_var_reset(Valu_top___024root* vlSelf) {
    ...
    vlSelf->data_mem_WD = VL_RAND_RESET_I(32);
    ...
    vlSelf->alu_top__DOT__ALUout = VL_RAND_RESET_I(32);
    for (int __Vi0=0; __Vi0<32; ++__Vi0) {
        vlSelf->alu_top__DOT__reg_file__DOT__regfile[__Vi0] = VL_RAND_RESET_I(32);
    }
    for (int __Vi0=0; __Vi0<32; ++__Vi0) {
        vlSelf->alu_top__DOT__data_mem__DOT__data_mem_register[__Vi0] = VL_RAND_RESET_I(32);
    }
