...
VL_ATTR_COLD void Vrisc_v___024root__trace_init_sub__TOP__0(Vrisc_v___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+58,"instruction", false,-1, 31,0);
    tracep->declBus(c+59,"pc_addr", false,-1, 7,0);
    ...
    tracep->declBit(c+5,"MEMsrc", false,-1);
    ...
    tracep->declBus(c+60,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBit(c+55,"clk", false,-1);
    tracep->declBit(c+61,"WE", false,-1);
    tracep->declBus(c+20,"A", false,-1, 7,0);
    ...
    tracep->declBus(c+63,"ADDRESS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+60,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBus(c+21,"pc", false,-1, 7,0);
    tracep->declBus(c+12,"instr", false,-1, 31,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+22,"WD3", false,-1, 31,0);
    tracep->declBus(c+15,"RD1", false,-1, 31,0);
    tracep->declBus(c+17,"RD2", false,-1, 31,0);
    tracep->declBus(c+57,"a0", false,-1, 31,0);
    for (int i = 0; i < 32; ++i) {
        tracep->declBus(c+23+i*1,"regfile", true,(i+0), 31,0);
    }
...
VL_ATTR_COLD void Vrisc_v___024root__trace_full_sub_0(Vrisc_v___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+3,(((0x98U == ((0x3f8U & (vlSelf->risc_v__DOT__instr 
                           ...
                           | (0x1aU == ((0x3f8U & (vlSelf->risc_v__DOT__instr 
                                        ...
                                        | (7U & (vlSelf->risc_v__DOT__instr 
                                                 >> 0xcU)))))));
    bufp->fullBit(oldp+4,((0x98U == ((0x3f8U & (vlSelf->risc_v__DOT__instr 
                                                << 3U)) 
                                     | (7U & (vlSelf->risc_v__DOT__instr 
                                              >> 0xcU))))));
    bufp->fullBit(oldp+5,((0x1aU == ((0x3f8U & (vlSelf->risc_v__DOT__instr 
                                                << 3U)) 
                                     | (7U & (vlSelf->risc_v__DOT__instr 
                                              >> 0xcU))))));
    bufp->fullIData(oldp+6,(vlSelf->risc_v__DOT__ImmOp),32);
    bufp->fullIData(oldp+7,(vlSelf->risc_v__DOT__pc),32);
    ...
    bufp->fullCData(oldp+10,((0x1fU & (vlSelf->risc_v__DOT__instr 
                                       >> 7U))),5);
    bufp->fullCData(oldp+11,(vlSelf->risc_v__DOT__ALUctrl),3);
    bufp->fullIData(oldp+12,(vlSelf->risc_v__DOT__instr),32);
    bufp->fullSData(oldp+13,(vlSelf->risc_v__DOT__ImmSrc),12);
    bufp->fullIData(oldp+14,(((((0x318U == ((0x3f8U 
                                             & (vlSelf->risc_v__DOT__instr 
                                                << 3U)) 
                                            | (7U & 
                                               (vlSelf->risc_v__DOT__instr 
    ...
    bufp->fullIData(oldp+15,(vlSelf->risc_v__DOT__ALUop1),32);
    bufp->fullIData(oldp+16,(vlSelf->risc_v__DOT__ALUop2),32);
    bufp->fullIData(oldp+17,(vlSelf->risc_v__DOT__reg_file__DOT__regfile
                             [(0x1fU & (vlSelf->risc_v__DOT__instr 
                                        >> 0x14U))]),32);
    bufp->fullIData(oldp+18,(((4U & (IData)(vlSelf->risc_v__DOT__ALUctrl))
    ...
    bufp->fullIData(oldp+19,(vlSelf->risc_v__DOT__data_mem__DOT__data_mem_register
                             [(0xffU & vlSelf->risc_v__DOT__ALUop1)]),32);
    bufp->fullCData(oldp+20,((0xffU & vlSelf->risc_v__DOT__ALUop1)),8);
    bufp->fullCData(oldp+21,((0xffU & vlSelf->risc_v__DOT__pc)),8);
    bufp->fullIData(oldp+22,(((0x1aU == ((0x3f8U & 
                                          (vlSelf->risc_v__DOT__instr 
                                           << 3U)) 
                                         | (7U & (vlSelf->risc_v__DOT__instr 
                                                  >> 0xcU))))
                               ...
                               : ((4U & (IData)(vlSelf->risc_v__DOT__ALUctrl))
                                   ...
                                   : ((2U & (IData)(vlSelf->risc_v__DOT__ALUctrl))
                                       ...
                                       : ((1U & (IData)(vlSelf->risc_v__DOT__ALUctrl))
                                           ...
                                           : (vlSelf->risc_v__DOT__ALUop1 
                                              + vlSelf->risc_v__DOT__ALUop2)))))),32);
    bufp->fullIData(oldp+23,(vlSelf->risc_v__DOT__reg_file__DOT__regfile[0]),32);
    bufp->fullIData(oldp+24,(vlSelf->risc_v__DOT__reg_file__DOT__regfile[1]),32);
    bufp->fullIData(oldp+25,(vlSelf->risc_v__DOT__reg_file__DOT__regfile[2]),32);
    bufp->fullIData(oldp+26,(vlSelf->risc_v__DOT__reg_file__DOT__regfile[3]),32);
    bufp->fullIData(oldp+27,(vlSelf->risc_v__DOT__reg_file__DOT__regfile[4]),32);
    bufp->fullIData(oldp+28,(vlSelf->risc_v__DOT__reg_file__DOT__regfile[5]),32);
    bufp->fullIData(oldp+29,(vlSelf->risc_v__DOT__reg_file__DOT__regfile[6]),32);
    bufp->fullIData(oldp+30,(vlSelf->risc_v__DOT__reg_file__DOT__regfile[7]),32);
    bufp->fullIData(oldp+31,(vlSelf->risc_v__DOT__reg_file__DOT__regfile[8]),32);
    bufp->fullIData(oldp+32,(vlSelf->risc_v__DOT__reg_file__DOT__regfile[9]),32);
    bufp->fullIData(oldp+33,(vlSelf->risc_v__DOT__reg_file__DOT__regfile[10]),32);
    bufp->fullIData(oldp+34,(vlSelf->risc_v__DOT__reg_file__DOT__regfile[11]),32);
    bufp->fullIData(oldp+35,(vlSelf->risc_v__DOT__reg_file__DOT__regfile[12]),32);
    bufp->fullIData(oldp+36,(vlSelf->risc_v__DOT__reg_file__DOT__regfile[13]),32);
    bufp->fullIData(oldp+37,(vlSelf->risc_v__DOT__reg_file__DOT__regfile[14]),32);
    bufp->fullIData(oldp+38,(vlSelf->risc_v__DOT__reg_file__DOT__regfile[15]),32);
    bufp->fullIData(oldp+39,(vlSelf->risc_v__DOT__reg_file__DOT__regfile[16]),32);
    bufp->fullIData(oldp+40,(vlSelf->risc_v__DOT__reg_file__DOT__regfile[17]),32);
    bufp->fullIData(oldp+41,(vlSelf->risc_v__DOT__reg_file__DOT__regfile[18]),32);
    bufp->fullIData(oldp+42,(vlSelf->risc_v__DOT__reg_file__DOT__regfile[19]),32);
    bufp->fullIData(oldp+43,(vlSelf->risc_v__DOT__reg_file__DOT__regfile[20]),32);
    bufp->fullIData(oldp+44,(vlSelf->risc_v__DOT__reg_file__DOT__regfile[21]),32);
    bufp->fullIData(oldp+45,(vlSelf->risc_v__DOT__reg_file__DOT__regfile[22]),32);
    bufp->fullIData(oldp+46,(vlSelf->risc_v__DOT__reg_file__DOT__regfile[23]),32);
    bufp->fullIData(oldp+47,(vlSelf->risc_v__DOT__reg_file__DOT__regfile[24]),32);
    bufp->fullIData(oldp+48,(vlSelf->risc_v__DOT__reg_file__DOT__regfile[25]),32);
    bufp->fullIData(oldp+49,(vlSelf->risc_v__DOT__reg_file__DOT__regfile[26]),32);
    bufp->fullIData(oldp+50,(vlSelf->risc_v__DOT__reg_file__DOT__regfile[27]),32);
    bufp->fullIData(oldp+51,(vlSelf->risc_v__DOT__reg_file__DOT__regfile[28]),32);
    bufp->fullIData(oldp+52,(vlSelf->risc_v__DOT__reg_file__DOT__regfile[29]),32);
    bufp->fullIData(oldp+53,(vlSelf->risc_v__DOT__reg_file__DOT__regfile[30]),32);
    bufp->fullIData(oldp+54,(vlSelf->risc_v__DOT__reg_file__DOT__regfile[31]),32);
    bufp->fullBit(oldp+55,(vlSelf->clk));
    bufp->fullBit(oldp+56,(vlSelf->rst));
    bufp->fullIData(oldp+57,(vlSelf->a0),32);
    bufp->fullIData(oldp+58,(vlSelf->instruction),32);
    bufp->fullCData(oldp+59,(vlSelf->pc_addr),8);
